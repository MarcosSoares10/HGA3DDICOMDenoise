% Função para re-iniciar a população
% Semelhante ao de criar populaçao porem inicia a população levando em conta a ja existente
...
mut1 = denoisedImages(1).img;	% Wiener Filter
